function main()
    ...
    room_size = [5000, 5000, 5];  % Room dimensions: [width, depth, height] in meters
...
function params = initialize_params()
    ...
    params.pTx = [2500; 0; 10];
    params.pRx = params.pTx + [10 * params.wavelength; 0; 0];
...
function plot_room(params)
    ...
    hold off;
    % Set figure paper properties for high resolution
set(gcf, 'PaperPositionMode', 'auto'); 
print(gcf, [num2str(params.fc/1e9) '10GHz_Heatmap.pdf'], '-dpdf', '-r300');
end
